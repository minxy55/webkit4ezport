...
DEFINES -= ENABLE_MATHML=1
DEFINES += ENABLE_MATHML=0
DEFINES -= ENABLE_SVG=1
DEFINES += ENABLE_SVG=0
DEFINES -= ENABLE_SVG_ANIMATION=1
DEFINES += ENABLE_SVG_ANIMATION=0
DEFINES -= ENABLE_INSPECTOR=1
DEFINES += ENABLE_INSPECTOR=0
DEFINES -= ENABLE_TOUCH_EVENTS=1
DEFINES += ENABLE_TOUCH_EVENTS=0
DEFINES -= ENABLE_ORIENTATION_EVENTS=1
DEFINES += ENABLE_ORIENTATION_EVENTS=0
DEFINES -= ENABLE_DEVICE_ORIENTATION=1
DEFINES += ENABLE_DEVICE_ORIENTATION=0
DEFINES -= ENABLE_DOM_STORAGE=1
