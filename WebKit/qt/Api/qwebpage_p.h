...
public:
...
#endif
    void keyPressEvent(EZKeyEvent*);
    void keyReleaseEvent(EZKeyEvent*);
    ...
    static QWebPage::WebAction editorActionForKeyEvent(EZKeyEvent* event);
#endif
